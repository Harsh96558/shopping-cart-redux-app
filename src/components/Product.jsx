...
const Product = ({ item }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 border-2   transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl  hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
      <div>
        <p className="text-gray-700 font-semibold text-lg  test-left truncate w-40 mt-1">{item.title}</p>
      </div>
      <div>
